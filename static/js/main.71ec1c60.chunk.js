...
`;var d=e=>{let{timeRemaining:t}=e;const{state:r}=Object(n.useContext)(A);return Object(l.jsxs)(u,{children:[Object(l.jsxs)("h1",{children:["Level ",r.level]}),Object(l.jsxs)("h1",{children:["Current Score: ",r.currentScore," / ",r.goalScore]}),Object(l.jsxs)("h1",{children:["Time Left: ",t]})]})};const h=(e,t)=>(e=Math.ceil(e),t=Math.floor(t),Math.floor(Math.random()*(t-e)+e)),j=e=>Math.PI/180*e,b=(e,t)=>{const r=Object(n.useRef)({values:t,handler:function(){for(var t=arguments.length,n=new Array(t),c=0;c<t;c++)n[c]=arguments[c];return e(...n,r.current.values)}});return r.current.values=t,r.current.handler},g=["gray","green","blue","purple","gold"],x=e=>({tier:e,effects:[]}),p=e=>{const t=(e=>{const t=[50,49,1,0,0];for(let r=1;r<=e;r++){let n=2;r>9?n=4:r>4&&(n=3);let c=0;for(let r=n;r>0;r--)t[r]=e++,c+=t[r];const i=100-c;t[0]=i}return t})(e),r=h(0,101);let n=0,c=0;for(let i=0;i<t.length;i++)if(n+=t[i],r<n){c=i;break}return{tier:c,effects:[]}},O=[x(0),x(0),x(0)],y=o.a.div`
  height: 100%;
  width: 100%;
`;var v=()=>{const{state:e,dispatch:t}=Object(n.useContext)(A),r=Object(n.useRef)(null),[c,i]=Object(n.useState)(),[s,o]=Object(n.useState)(),[u,x]=Object(n.useState)(),p=Object(n.useRef)({x:500,y:500}),O=Object(n.useRef)([]),v=Object(n.useRef)(e);Object(n.useEffect)((()=>{v.current=e}),[e]),Object(n.useEffect)((()=>{const e=r.current;i(e);const t=r.current.getContext("2d");o(t),r.current.width=window.innerWidth,r.current.height=window.innerHeight,e.requestPointerLock();const n=()=>C(e);return document.addEventListener("pointerlockchange",n,!1),document.addEventListener("click",m),()=>{document.removeEventListener("pointerlockchange",n),document.removeEventListener("click",m),document.exitPointerLock()}}),[]),Object(n.useEffect)((()=>{let e;return c&&s&&(e=a.a(S)),()=>e&&e.stop()}),[c,s]);const m=()=>{const e=p.current.x,r=p.current.y,n=O.current,c=n.filter((t=>{let{x:n,y:c,radius:i}=t;return Math.sqrt(Math.pow(n-e,2),Math.pow(c-r,2))>=i+5}));c.length===n.length?t({type:"hitTarget",payload:{inc:-1}}):t({type:"hitTarget",payload:{inc:1}}),O.current=c},f=(e,t)=>{const{width:r,height:n}=e;t.fillStyle="white",t.fillRect(0,0,r,n),(e=>{O.current.forEach((t=>{let{x:r,y:n,radius:c,target:i}=t;e.fillStyle=g[i.tier],e.beginPath(),e.arc(r,n,c,0,j(360),!0),e.fill(),e.closePath()}))})(t),t.fillStyle="#f00",t.beginPath(),t.arc(p.current.x,p.current.y,5,0,j(360),!0),t.fill(),t.closePath()},S=b(((r,n)=>{let[c,i]=n;if(!c||!i)return;(t=>{if(!O.current.length&&t){const{targetSize:r,targets:n}=e,{width:c,height:i}=t,s=h(c/2-c/4,c-r-c/2),o=h(i/2-i/4,i-r-i/2),a=n[h(0,n.length)];O.current=[{x:s,y:o,radius:r,target:a}]}})(c),f(c,i);const s=(e.timer-r/1e3).toFixed(2);if(s<=0)return t({type:"endRound"});x(s)}),[c,s]),C=e=>{document.pointerLockElement!==e&&document.mozPointerLockElement!==e||e.addEventListener("mousemove",(e=>k(e)),!1)},k=b(((t,r)=>{let[n,c]=r;if(!c)return;const{x:i,y:s}=n.current;if(i>c.width)return void(n.current={x:c.width-1,y:s});if(s>c.height)return void(n.current={x:i,y:c.height-1});if(i<0)return void(n.current={x:1,y:s});if(s<0)return void(n.current={x:i,y:1});const o=t.movementX*(e.sensitivity||1),a=t.movementY*(e.sensitivity||1);n.current={x:i+o,y:s+a}}),[p,c]);return Object(l.jsxs)(y,{children:[Object(l.jsx)(d,{timeRemaining:u}),Object(l.jsx)("canvas",{ref:r})]})};const m=o.a.div`
